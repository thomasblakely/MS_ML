#!/usr/bin/env python3
"""
MS Screening Analysis - CORRECTED VERSION

Key fixes:
1. Consistent label convention: MS = positive class = 1
2. P(MS) scores used throughout
3. Proper ROC with pos_label=1 (MS)
4. Patient-weighted class weighting
5. Explicit tracking of exclusions
"""
